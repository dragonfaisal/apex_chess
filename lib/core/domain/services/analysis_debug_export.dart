...
class AnalysisDebugExport {
  ...
  static Map<String, Object?> _movePayload(MoveAnalysis m) => {
    ...
    'motifReasonCode': m.tacticalVerdict.reasonCode,
    'sacrificeTrajectory': m.tacticalVerdict.sacrificeTrajectory,
    'delayedSacrifice': m.tacticalVerdict.delayedSacrifice,
    'movedPieceCapturedInPV': m.tacticalVerdict.movedPieceCapturedInPV,
    'capturedOnPlyOffset': m.tacticalVerdict.capturedOnPlyOffset,
    'forcedMateInPV': m.tacticalVerdict.forcedMate,
    'promotionInPV': m.tacticalVerdict.forcedPromotion,
    'firstCommitmentPly': m.tacticalVerdict.firstCommitmentPly,
    'candidateVerified': m.tacticalVerdict.candidateVerified,
    'verifiedDepth': m.tacticalVerdict.verificationDepth,
    'verifiedMultiPV': m.tacticalVerdict.verificationMultiPV,
    'lowDepthRank': m.tacticalVerdict.lowDepthRank,
    'highDepthRank': m.tacticalVerdict.highDepthRank,
    'lowDepthScore': m.tacticalVerdict.lowDepthScore,
    'highDepthScore': m.tacticalVerdict.highDepthScore,
    'lowDepthBestMove': m.tacticalVerdict.lowDepthBestMove,
    'highDepthBestMove': m.tacticalVerdict.highDepthBestMove,
    'nonObviousScore': m.tacticalVerdict.nonObviousScore,
    'forcingLineLength': m.tacticalVerdict.forcingLineLength,
    'forcedMate': m.tacticalVerdict.forcedMate,
    'forcedPromotion': m.tacticalVerdict.forcedPromotion,
    'decisiveMaterialWin': m.tacticalVerdict.decisiveMaterialWin,
    'queenSacrifice': m.tacticalVerdict.queenSacrifice,
    'rookSacrifice': m.tacticalVerdict.rookSacrifice,
    'decoy': m.tacticalVerdict.decoy,
    'deflection': m.tacticalVerdict.deflection,
    'matingNet': m.tacticalVerdict.matingNet,
    'promotionNet': m.tacticalVerdict.promotionNet,
