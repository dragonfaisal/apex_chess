...
const debugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticVersion =
    'debug-only-bridge-analyzer-adapter-controlled-runtime-input-preflight-diagnostic-v1';

enum DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticStatus {
  controlledAnalyzerAdapterRuntimeInputPreflightDiagnosticReadyWithWarnings(
    'controlledAnalyzerAdapterRuntimeInputPreflightDiagnosticReadyWithWarnings',
  ),
  controlledAnalyzerAdapterRuntimeInputPreflightDiagnosticReadyClean(
    'controlledAnalyzerAdapterRuntimeInputPreflightDiagnosticReadyClean',
  ),
  blockedByUnsafeRuntimeInputPreflight('blockedByUnsafeRuntimeInputPreflight'),
  blockedByPolicyBoundary('blockedByPolicyBoundary'),
  invalidRuntimeInputPreflightDiagnostic(
    'invalidRuntimeInputPreflightDiagnostic',
  );

  const DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticStatus(
    this.wire,
  );
...
enum DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticMode {
  defaultMode('default'),
  allSafe('all-safe'),
  checks('checks'),
  decision('decision'),
  ...
  const DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticMode(
    this.wire,
  );
...
class DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticRow {
  const DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticRow({
    required this.diagnosticRowId,
    required this.runtimeInputPreflightId,
  ...
  final String runtimeInputPreflightId;
  ...
  DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticRow
  copyWith({
    String? diagnosticRowId,
    String? runtimeInputPreflightId,
    String? sourcePhase,
    ...
    return DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticRow(
      diagnosticRowId: diagnosticRowId ?? this.diagnosticRowId,
      runtimeInputPreflightId:
          runtimeInputPreflightId ?? this.runtimeInputPreflightId,
  ...
  Map<String, Object?> toJson() {
    return <String, Object?>{
      ...
      'runtimeInputPreflightId': runtimeInputPreflightId,
...
class DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticResult {
  ...
  final DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticStatus
  status;
  ...
  String renderMarkdown() {
    final buffer = StringBuffer()
      ...
      ..writeln()
      ..writeln(
        '- version: $debugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticVersion',
      )
      ..writeln('- runtime input preflight diagnostic status: ${status.wire}')
      ..writeln('- runtime input preflight diagnostic mode: ${mode.wire}')
      ..writeln(
      ...
      ..writeln('- safe for Phase 34Q: $safeForPhase34Q')
      ...
      ..writeln()
      ..writeln('## Runtime Input Preflight Diagnostic Rows')
      ..writeln(
        '| Row | Mode | Checks | Decision | Blocked reasons | Seam performed | Execution performed | Runtime approved | Analyzer input approved | Analyzer input produced | Findings |',
      )
      ..writeln(
        '| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |',
      );
    for (final row in rows) {
      buffer.writeln(
        '| ${row.diagnosticRowId} | ${row.diagnosticMode} | ${_ids(row.checkIds)} | ${row.decisionId} | ${_ids(row.blockedReasonIds)} | ${row.seamProbePerformed} | ${row.executionPerformed} | ${row.runtimeExecutionApproved} | ${row.analyzerRuntimeInputApproved} | ${row.analyzerRuntimeInputProduced} | ${_ids(row.findings)} |',
      );
    }
    buffer
      ..writeln()
  ...
  Map<String, Object?> toJson() {
    return <String, Object?>{
      ...
      'sourceRuntimeExecutionPreflightStatus':
          sourceRuntimeExecutionPreflightStatus,
      'safeForPhase34Q': safeForPhase34Q,
...
class DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnostic {
  ...
  evaluate({
    ...
    final runtimeInputPreflight =
        ...
        const DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflight()
            .evaluate(
              ...
              runtimeExecutionPreflightDiagnosticResult:
                  runtimeExecutionPreflightDiagnosticResult,
              runtimeExecutionPreflightResult: runtimeExecutionPreflightResult,
            );
    final rows = _rowsFor(runtimeInputPreflight, mode);
    final findings = _sorted(<String>[
      if (runtimeInputPreflight.hasUnsafePolicyViolation ||
          !runtimeInputPreflight.safeForPhase34P)
        'unsafePhase34OControlledRuntimeInputPreflight',
      ...
      if (runtimeExecutionPreflightResult != null &&
          (runtimeExecutionPreflightResult.hasUnsafePolicyViolation ||
              !runtimeExecutionPreflightResult.safeForPhase34L))
    ...
    final safeForPhase34Q = findings.isEmpty;
    return DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticResult(
      status: !safeForPhase34Q
      ...
      sourceRuntimeExecutionPreflightStatus:
          runtimeInputPreflight.sourceRuntimeExecutionPreflightStatus,
      rows: rows,
      findings: findings,
      safeForPhase34Q: safeForPhase34Q,
      nextRecommendation: safeForPhase34Q
          ? _phase34QRecommendation
          : 'blockedByUnsafeRuntimeInputPreflightDiagnostic',
    );
  }
}

class DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticValidator {
  const DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticValidator();
  ...
  List<String> validateRow(
    ...
    return _sorted(<String>[
      ...
      if (row.recommendation != _phase34QRecommendation)
        'missingPhase34QDisabledRuntimeInputEnvelopeRecommendation',
      ...
      if (row.checkIds.any((id) => id.startsWith('active:')))
        'runtimeInputPreflightCheckActivated',
...
List<DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticRow>
_rowsFor(
  ControlledAnalyzerAdapterRuntimeInputPreflightResult preflight,
  DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticMode
  mode,
) {
  final rows =
  ...
  if (includeAll ||
    ...
    rows.add(
      _row(
        ...
        seamProbePerformed: preflight.decision.seamProbePerformed,
      ...
      preflight.blockedReasons.map(
        (reason) => _row(
          ...
          diagnosticStatus: reason.blocked
              ? 'runtimeInputBlockedReasonRemainsBlocked'
              : 'runtimeInputBlockedReasonUnsafe',
        ),
      ),
    );
  }
    ...
    rows.add(
      _row(
        ...
        blockedReasonIds: preflight.blockedReasons
            ...
            .toList(),
        diagnosticStatus: 'phase34QDisabledRuntimeInputEnvelopeRecommendation',
      ),
    );
  }
  return rows;
...
DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticRow _row(
  ControlledAnalyzerAdapterRuntimeInputPreflightResult preflight,
  DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticMode
  mode, {
  ...
  return DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputPreflightDiagnosticRow(
    diagnosticRowId: diagnosticRowId,
    runtimeInputPreflightId: preflight.input.preflightId,
    ...
    seamProbeRequested: preflight.input.seamProbeRequested,
    ...
    analyzerRuntimeInputApproved: analyzerRuntimeInputApproved ?? false,
    ...
    recommendation: _phase34QRecommendation,
  );
}
...
const _phase34QRecommendation =
    'implementDisabledAnalyzerAdapterRuntimeInputEnvelopePatch';
const _checkRowPrefix = 'runtime-input-preflight-diagnostic-check';
const _decisionRowPrefix = 'runtime-input-preflight-diagnostic-decision';
const _blockedReasonRowPrefix =
    'runtime-input-preflight-diagnostic-blocked-reason';
const _deniedRowPrefix = 'runtime-input-preflight-diagnostic-denied';
const _proofRowPrefix = 'runtime-input-preflight-diagnostic-proof';
const _recommendationRowPrefix =
    'runtime-input-preflight-diagnostic-recommendation';
