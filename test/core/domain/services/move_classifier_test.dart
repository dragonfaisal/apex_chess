...
void main() {
  ...
  group('Brilliant gate', () {
    test('Sacrifice while already +6 is NOT Brilliant (winning showmanship)',
        () {
    ...
    test('Sacrifice when an alt line was trivially winning is NOT Brilliant',
        () {
  ...
  group('Black perspective', () {
    test('Black move that improves Black reads as positive ΔW (not Blunder)',
        () {
    ...
    test('Black with mate=−5 is mate FOR Black (Win% from Black POV ≈ 100)',
        () {
  ...
  group('Mate sign direction', () {
    test('Position with mate=+3 (White mates) registers as winning for White',
        () {
  ...
  group('Missed Win', () {
    ...
    test('Mover was winning, position now LOSING ⇒ Blunder (not Missed Win)',
        () {
      final cls = classifier.classify(const MoveClassificationInput(
        isWhiteMove: true,
        prevWhiteCp: 400,
  ...
  group('cp-loss safety net', () {
    ...
    test('Safety net cannot escalate Excellent → Blunder via cp loss alone',
        () {
