...
enum DebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticSection {
  ...
  disabledRuntimeExecutionSeamProbe('disabled-runtime-execution-seam-probe'),
  runtimeInputPreflight('runtime-input-preflight'),
...
class DebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticCommandResult {
  const DebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticCommandResult({
    ...
    this.disabledRuntimeExecutionSeamProbe,
    ...
    this.disabledRuntimeInputEnvelope,
    this.disabledRuntimeInputEnvelopeDiagnosticMode,
    this.disabledRuntimeInputEnvelopeDiagnostic,
  ...
  final DisabledAnalyzerAdapterRuntimeExecutionSeamProbeResult?
  disabledRuntimeExecutionSeamProbe;
  ...
  final DebugOnlyBridgeAnalyzerAdapterDisabledRuntimeExecutionSeamProbeDiagnosticResult?
  ...
  final DisabledAnalyzerAdapterRuntimeInputEnvelopeResult?
  disabledRuntimeInputEnvelope;
  final DebugOnlyBridgeAnalyzerAdapterDisabledRuntimeInputEnvelopeDiagnosticMode?
  disabledRuntimeInputEnvelopeDiagnosticMode;
...
class DebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticCommandRequest {
  ...
  const DebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticCommandRequest.invalid(
    this.failure,
      ...
      disabledRuntimeInputEnvelopeDiagnosticMode = null,
      runtimeInputEnvelopeActivationPreflightDiagnosticMode = null,
...
runDebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticCommand({
  ...
  if (request.listGoldenCases) {
    ...
    return DebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticCommandResult(
      ...
      disabledRuntimeExecutionSeamProbeDiagnosticMode:
          request.disabledRuntimeExecutionSeamProbeDiagnosticMode,
      disabledRuntimeInputEnvelopeDiagnosticMode:
          request.disabledRuntimeInputEnvelopeDiagnosticMode,
  ...
  final includeDisabledRuntimeInputEnvelope =
      _includeSection(
        request.section,
        DebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticSection
            .disabledRuntimeInputEnvelope,
      ) ||
      includeDisabledRuntimeInputEnvelopeDiagnostic ||
      includeRuntimeInputEnvelopeActivationPreflight;
  final includeRuntimeInputPreflight =
      ...
      includeDisabledRuntimeInputEnvelope;
  ...
  final includeDisabledRuntimeExecutionSeamProbe =
      _includeSection(
        request.section,
        DebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticSection
            .disabledRuntimeExecutionSeamProbe,
      ) ||
      includeDisabledRuntimeExecutionSeamProbeDiagnostic ||
      includeRuntimeInputPreflight;
  final includeRuntimeExecutionPreflight =
      ...
      includeDisabledRuntimeExecutionSeamProbe;
  ...
  final disabledRuntimeExecutionSeamProbe =
      includeDisabledRuntimeExecutionSeamProbe
      ...
      : null;
  final disabledRuntimeExecutionSeamProbeDiagnostic =
      includeDisabledRuntimeExecutionSeamProbeDiagnostic
      ? const DebugOnlyBridgeAnalyzerAdapterDisabledRuntimeExecutionSeamProbeDiagnostic()
            .evaluate(
              seamProbeResult: disabledRuntimeExecutionSeamProbe,
              runtimeExecutionPreflightDiagnosticResult:
                  runtimeExecutionPreflightDiagnostic,
              runtimeExecutionPreflightResult: runtimeExecutionPreflight,
              disabledRuntimeSkeletonDiagnosticResult:
      ...
      : null;
  final runtimeInputPreflight = includeRuntimeInputPreflight
  ...
  final disabledRuntimeInputEnvelope = includeDisabledRuntimeInputEnvelope
      ...
      : null;
  final disabledRuntimeInputEnvelopeDiagnostic =
      includeDisabledRuntimeInputEnvelopeDiagnostic
      ...
      : null;
  final runtimeInputEnvelopeActivationPreflight =
      includeRuntimeInputEnvelopeActivationPreflight
      ...
      : null;
  final runtimeInputEnvelopeActivationPreflightDiagnostic =
      includeRuntimeInputEnvelopeActivationPreflightDiagnostic
  ...
  final stdoutText = switch (request.format) {
    DebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticFormat.markdown =>
      _renderMarkdown(
        ...
        disabledRuntimeInputEnvelope: disabledRuntimeInputEnvelope,
        disabledRuntimeInputEnvelopeDiagnostic:
            disabledRuntimeInputEnvelopeDiagnostic,
        runtimeInputEnvelopeActivationPreflight:
            runtimeInputEnvelopeActivationPreflight,
  ...
  final reportFindings = <String>[
    ...
    if (runtimeExecutionPreflightDiagnostic != null)
      ...const DebugOnlyBridgeAnalyzerAdapterControlledRuntimeExecutionPreflightDiagnosticValidator()
          .validateReportText(stdoutText),
    if (disabledRuntimeExecutionSeamProbe != null)
      ...const DisabledAnalyzerAdapterRuntimeExecutionSeamProbeValidator()
          .validateReportText(stdoutText),
    if (disabledRuntimeExecutionSeamProbeDiagnostic != null)
  ...
  return DebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticCommandResult(
    ...
    disabledRuntimeInputEnvelopeDiagnosticMode:
        request.disabledRuntimeInputEnvelopeDiagnosticMode,
    runtimeInputEnvelopeActivationPreflightDiagnosticMode:
        request.runtimeInputEnvelopeActivationPreflightDiagnosticMode,
    runtimeExecutionPreflightDiagnostic: runtimeExecutionPreflightDiagnostic,
    disabledRuntimeExecutionSeamProbe: disabledRuntimeExecutionSeamProbe,
    disabledRuntimeExecutionSeamProbeDiagnostic:
        disabledRuntimeExecutionSeamProbeDiagnostic,
...
validateDebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticArgs(
  ...
  var disabledRuntimeInputEnvelopeDiagnosticSeen = false;
  var runtimeInputEnvelopeActivationPreflightDiagnosticSeen = false;
  ...
  for (final arg in args) {
    ...
    if (arg.startsWith(_disabledRuntimeExecutionSeamProbeDiagnosticFlag)) {
      if (disabledRuntimeExecutionSeamProbeDiagnosticSeen) {
        return const DebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticCommandRequest.invalid(
          'duplicateDisabledSeamProbeDiagnostic',
        );
      }
      final parsed = _disabledRuntimeExecutionSeamProbeDiagnosticModeByWire(
        arg
            .substring(_disabledRuntimeExecutionSeamProbeDiagnosticFlag.length)
            .trim(),
      );
      if (parsed == null) {
        return const DebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticCommandRequest.invalid(
      ...
      disabledRuntimeExecutionSeamProbeDiagnosticMode = parsed;
    ...
    if (arg.startsWith(_disabledRuntimeInputEnvelopeDiagnosticFlag)) {
      if (disabledRuntimeInputEnvelopeDiagnosticSeen) {
        return const DebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticCommandRequest.invalid(
          'duplicateDisabledRuntimeInputEnvelopeDiagnostic',
        );
      }
      final parsed = _disabledRuntimeInputEnvelopeDiagnosticModeByWire(
        arg
            .substring(_disabledRuntimeInputEnvelopeDiagnosticFlag.length)
            .trim(),
      );
      if (parsed == null) {
        return const DebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticCommandRequest.invalid(
      ...
      disabledRuntimeInputEnvelopeDiagnosticMode = parsed;
      disabledRuntimeInputEnvelopeDiagnosticSeen = true;
      continue;
    }
    if (arg.startsWith(
      _runtimeInputEnvelopeActivationPreflightDiagnosticFlag,
    )) {
      if (runtimeInputEnvelopeActivationPreflightDiagnosticSeen) {
        return const DebugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticCommandRequest.invalid(
          'duplicateRuntimeInputEnvelopeActivationPreflightDiagnostic',
        );
      }
      final parsed =
          _runtimeInputEnvelopeActivationPreflightDiagnosticModeByWire(
            arg
                .substring(
                  _runtimeInputEnvelopeActivationPreflightDiagnosticFlag.length,
                )
                .trim(),
          );
      if (parsed == null) {
      ...
      runtimeInputEnvelopeActivationPreflightDiagnosticMode = parsed;
      runtimeInputEnvelopeActivationPreflightDiagnosticSeen = true;
      continue;
    }
...
int debugOnlyBridgeAnalyzerAdapterPrototypeDiagnosticCommandExitCode(
  ...
  if (diagnostic.hasUnsafePolicyViolation ||
      ...
      (disabledRuntimeInputEnvelope?.hasUnsafePolicyViolation ?? false) ||
      (disabledRuntimeInputEnvelopeDiagnostic?.hasUnsafePolicyViolation ??
          false) ||
  ...
  if (request.strict &&
      (diagnostic.blockerCount > 0 ||
          ...
          (runtimeExecutionPreflightDiagnostic?.hasUnsafePolicyViolation ??
              false) ||
          (disabledRuntimeExecutionSeamProbe?.hasUnsafePolicyViolation ??
              false) ||
          (disabledRuntimeExecutionSeamProbeDiagnostic
                  ?.hasUnsafePolicyViolation ??
              false) ||
...
String _renderMarkdown(
  ...
  if (disabledRuntimeExecutionSeamProbe != null &&
    ...
    _writeDisabledRuntimeExecutionSeamProbe(
      buffer,
      disabledRuntimeExecutionSeamProbe,
    );
  }
  if (disabledRuntimeExecutionSeamProbeDiagnostic != null) {
    _writeDisabledRuntimeExecutionSeamProbeDiagnostic(
      buffer,
      disabledRuntimeExecutionSeamProbeDiagnostic,
    );
  }
  ...
  if (disabledRuntimeInputEnvelope != null &&
    ...
    _writeDisabledRuntimeInputEnvelope(buffer, disabledRuntimeInputEnvelope);
  }
  if (disabledRuntimeInputEnvelopeDiagnostic != null) {
    _writeDisabledRuntimeInputEnvelopeDiagnostic(
      buffer,
      disabledRuntimeInputEnvelopeDiagnostic,
    );
  }
  if (runtimeInputEnvelopeActivationPreflight != null &&
    ...
    _writeRuntimeInputEnvelopeActivationPreflight(
      buffer,
      runtimeInputEnvelopeActivationPreflight,
    );
  }
  if (runtimeInputEnvelopeActivationPreflightDiagnostic != null) {
    _writeRuntimeInputEnvelopeActivationPreflightDiagnostic(
      buffer,
      runtimeInputEnvelopeActivationPreflightDiagnostic,
    );
  }
...
Map<String, Object?> _jsonPayload(
  ...
  if (disabledRuntimeExecutionSeamProbe != null &&
    ...
    payload['disabledRuntimeExecutionSeamProbe'] =
        disabledRuntimeExecutionSeamProbe.toJson();
  }
  if (disabledRuntimeExecutionSeamProbeDiagnostic != null) {
    payload['disabledRuntimeExecutionSeamProbeDiagnostic'] =
        disabledRuntimeExecutionSeamProbeDiagnostic.toJson();
  }
  if (runtimeInputPreflight != null &&
      _includeSection(
        section,
  ...
  if (disabledRuntimeInputEnvelope != null &&
    ...
    payload['disabledRuntimeInputEnvelope'] = disabledRuntimeInputEnvelope
        .toJson();
  }
  if (disabledRuntimeInputEnvelopeDiagnostic != null) {
    payload['disabledRuntimeInputEnvelopeDiagnostic'] =
        disabledRuntimeInputEnvelopeDiagnostic.toJson();
  }
  if (runtimeInputEnvelopeActivationPreflight != null &&
      _includeSection(
        section,
    ...
    payload['runtimeInputEnvelopeActivationPreflight'] =
        runtimeInputEnvelopeActivationPreflight.toJson();
  }
  if (runtimeInputEnvelopeActivationPreflightDiagnostic != null) {
...
void _writeDisabledRuntimeExecutionSeamProbe(
  StringBuffer buffer,
  DisabledAnalyzerAdapterRuntimeExecutionSeamProbeResult result,
) {
  buffer
    ..writeln('## Disabled Runtime Execution Seam Probe')
    ..writeln('- seam probe status: ${result.status.wire}')
    ..writeln(
      '- source preflight diagnostic status: ${result.sourcePreflightDiagnosticStatus}',
    )
    ..writeln('- source preflight status: ${result.sourcePreflightStatus}')
    ..writeln('- safe for Phase 34N: ${result.safeForPhase34N}')
    ..writeln('- next recommendation: ${result.nextRecommendation}')
    ..writeln('- seam probe attempt count: ${result.seamProbeAttemptCount}')
    ...
    ..writeln(
      '- analyzer runtime input count: ${result.analyzerRuntimeInputCount}',
    )
    ..writeln('- analyzer wiring count: ${result.analyzerWiringCount}')
    ..writeln('- engine call count: ${result.engineCallCount}')
    ..writeln('- scheduler execution count: ${result.schedulerExecutionCount}')
  ...
  buffer
    ..writeln()
    ..writeln('### Seam Probe Blocked Reasons')
...
void _writeDisabledRuntimeExecutionSeamProbeDiagnostic(
  StringBuffer buffer,
  DebugOnlyBridgeAnalyzerAdapterDisabledRuntimeExecutionSeamProbeDiagnosticResult
  result,
) {
  buffer
    ..writeln('## Disabled Runtime Execution Seam Probe Diagnostic Run')
    ..writeln('- diagnostic status: ${result.status.wire}')
    ..writeln('- disabled seam probe diagnostic mode: ${result.mode.wire}')
    ..writeln('- source seam probe status: ${result.sourceSeamProbeStatus}')
    ..writeln(
      '- source preflight diagnostic status: ${result.sourcePreflightDiagnosticStatus}',
    )
    ..writeln('- safe for Phase 34O: ${result.safeForPhase34O}')
    ..writeln('- next recommendation: ${result.nextRecommendation}')
    ..writeln('- total diagnostic rows: ${result.totalDiagnosticRows}')
    ..writeln('- request rows: ${result.requestDiagnosticRowCount}')
    ..writeln('- response rows: ${result.responseDiagnosticRowCount}')
    ..writeln('- attempt rows: ${result.attemptDiagnosticRowCount}')
    ..writeln('- boundary rows: ${result.boundaryDiagnosticRowCount}')
    ..writeln(
      '- blocked reason rows: ${result.blockedReasonDiagnosticRowCount}',
    )
    ..writeln('- denied rows: ${result.deniedDiagnosticRowCount}')
    ...
    ..writeln()
    ..writeln(
      '| Row | Mode | Request | Response | Attempt | Seam performed | Execution performed | Runtime approved | Analyzer input produced | Findings |',
    )
    ..writeln('| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |');
  for (final row in result.rows) {
    buffer.writeln(
      '| ${row.diagnosticRowId} | ${row.diagnosticMode} | ${row.requestId} | ${row.responseId} | ${row.attemptId} | ${row.seamProbePerformed} | ${row.executionPerformed} | ${row.runtimeExecutionApproved} | ${row.analyzerRuntimeInputProduced} | ${_ids(row.findings)} |',
    );
  }
  buffer.writeln();
}

void _writeRuntimeInputPreflight(
  StringBuffer buffer,
  ControlledAnalyzerAdapterRuntimeInputPreflightResult result,
) {
  buffer
    ..writeln('## Controlled Runtime Input Preflight')
    ..writeln('- runtime input preflight status: ${result.status.wire}')
    ..writeln(
      '- source seam probe diagnostic status: ${result.sourceSeamProbeDiagnosticStatus}',
    )
    ..writeln('- source seam probe status: ${result.sourceSeamProbeStatus}')
    ..writeln(
      '- source runtime execution preflight diagnostic status: ${result.sourceRuntimeExecutionPreflightDiagnosticStatus}',
    )
    ..writeln(
      '- source runtime execution preflight status: ${result.sourceRuntimeExecutionPreflightStatus}',
    )
    ...
    ..writeln('- active denied field count: ${result.activeDeniedFieldCount}')
    ..writeln()
    ..writeln('### Runtime Input Preflight Checks')
    ..writeln('| Check | Passed |')
    ..writeln('| --- | --- |');
  for (final check in result.checks) {
    buffer.writeln('| ${check.checkId} | ${check.passed} |');
  }
  buffer
    ..writeln()
    ..writeln('### Runtime Input Decision')
    ...
    ..writeln('- executionAllowed: ${result.decision.executionAllowed}')
    ..writeln()
    ..writeln('### Runtime Input Blocked Reasons')
    ..writeln('| Reason | Surface | Blocked |')
    ..writeln('| --- | --- | --- |');
  for (final reason in result.blockedReasons) {
    buffer.writeln(
...
void _writeDisabledRuntimeInputEnvelope(
  StringBuffer buffer,
  DisabledAnalyzerAdapterRuntimeInputEnvelopeResult result,
) {
  buffer
    ..writeln('## Disabled Runtime Input Envelope')
    ..writeln('- disabled runtime input envelope status: ${result.status.wire}')
    ..writeln(
      '- source runtime input preflight diagnostic status: ${result.sourceRuntimeInputPreflightDiagnosticStatus}',
    )
    ..writeln(
      '- source runtime input preflight status: ${result.sourceRuntimeInputPreflightStatus}',
    )
...
void _writeDisabledRuntimeInputEnvelopeDiagnostic(
  StringBuffer buffer,
  DebugOnlyBridgeAnalyzerAdapterDisabledRuntimeInputEnvelopeDiagnosticResult
  result,
) {
  buffer
    ..writeln('## Disabled Runtime Input Envelope Diagnostic Run')
    ..writeln('- diagnostic status: ${result.status.wire}')
    ..writeln(
      '- disabled runtime input envelope diagnostic mode: ${result.mode.wire}',
    )
    ..writeln(
      '- source disabled runtime input envelope status: ${result.sourceDisabledRuntimeInputEnvelopeStatus}',
    )
    ..writeln(
      '- source runtime input preflight diagnostic status: ${result.sourceRuntimeInputPreflightDiagnosticStatus}',
    )
    ..writeln('- safe for Phase 34S: ${result.safeForPhase34S}')
    ..writeln('- next recommendation: ${result.nextRecommendation}')
    ..writeln('- disabled envelope count: ${result.disabledEnvelopeCount}')
    ..writeln(
      '- active runtime input envelope count: ${result.activeRuntimeInputEnvelopeCount}',
    ...
    ..writeln()
    ..writeln(
      '| Row | Mode | Slots | Boundaries | Blocked reasons | Active envelope | Analyzer input approved | Analyzer input produced | Findings |',
    )
    ..writeln('| --- | --- | --- | --- | --- | --- | --- | --- | --- |');
  for (final row in result.rows) {
    buffer.writeln(
      '| ${row.diagnosticRowId} | ${row.diagnosticMode} | ${_ids(row.slotIds)} | ${_ids(row.boundaryIds)} | ${_ids(row.blockedReasonIds)} | ${row.activeRuntimeInputEnvelope} | ${row.analyzerRuntimeInputApproved} | ${row.analyzerRuntimeInputProduced} | ${_ids(row.findings)} |',
    );
  }
  buffer.writeln();
}

void _writeRuntimeInputEnvelopeActivationPreflight(
  StringBuffer buffer,
  ControlledAnalyzerAdapterRuntimeInputEnvelopeActivationPreflightResult result,
) {
  buffer
    ..writeln('## Runtime Input Envelope Activation Preflight')
    ..writeln('- activation preflight status: ${result.status.wire}')
    ..writeln(
      '- source disabled runtime input envelope diagnostic status: ${result.sourceDisabledRuntimeInputEnvelopeDiagnosticStatus}',
    )
    ..writeln(
      '- source disabled runtime input envelope status: ${result.sourceDisabledRuntimeInputEnvelopeStatus}',
    )
...
void _writeRuntimeInputEnvelopeActivationPreflightDiagnostic(
  StringBuffer buffer,
  DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputEnvelopeActivationPreflightDiagnosticResult
  result,
) {
  buffer
    ..writeln('## Runtime Input Envelope Activation Preflight Diagnostic Run')
    ..writeln('- diagnostic status: ${result.status.wire}')
    ..writeln(
      '- runtime input envelope activation preflight diagnostic mode: ${result.mode.wire}',
    )
    ..writeln(
    ...
    ..writeln('- safe for Phase 34U: ${result.safeForPhase34U}')
    ..writeln('- next recommendation: ${result.nextRecommendation}')
    ..writeln('- total diagnostic rows: ${result.totalDiagnosticRows}')
    ..writeln('- check diagnostic rows: ${result.checkDiagnosticRowCount}')
    ..writeln(
      '- decision diagnostic rows: ${result.decisionDiagnosticRowCount}',
    )
    ..writeln(
      '- blocked reason diagnostic rows: ${result.blockedReasonDiagnosticRowCount}',
    )
    ..writeln('- denied diagnostic rows: ${result.deniedDiagnosticRowCount}')
    ..writeln('- proof diagnostic rows: ${result.proofDiagnosticRowCount}')
    ..writeln(
    ...
    ..writeln()
    ..writeln(
      '| Row | Mode | Checks | Decision | Blocked reasons | Activation approved | Activation performed | Active envelope | Payloads | Analyzer input approved | Analyzer input produced | Runtime approved | Findings |',
    )
    ..writeln(
      '| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |',
    );
  for (final row in result.rows) {
    buffer.writeln(
      '| ${row.diagnosticRowId} | ${row.diagnosticMode} | ${_ids(row.checkIds)} | ${row.decisionId} | ${_ids(row.blockedReasonIds)} | ${row.activationApproved} | ${row.activationPerformed} | ${row.activeRuntimeInputEnvelope} | ${row.playablePayloadCount} | ${row.analyzerRuntimeInputApproved} | ${row.analyzerRuntimeInputProduced} | ${row.runtimeExecutionApproved} | ${_ids(row.findings)} |',
    );
  }
  buffer
    ..writeln()
    ..writeln('- android proof IDs: ${_ids(result.rows.first.androidProofIds)}')
    ..writeln('- owner proof queue count: ${result.ownerProofQueueCount}')
    ..writeln();
}
...
DebugOnlyBridgeAnalyzerAdapterDisabledRuntimeExecutionSeamProbeDiagnosticMode?
_disabledRuntimeExecutionSeamProbeDiagnosticModeByWire(String wire) {
  for (final mode
...
DebugOnlyBridgeAnalyzerAdapterDisabledRuntimeInputEnvelopeDiagnosticMode?
_disabledRuntimeInputEnvelopeDiagnosticModeByWire(String wire) {
  for (final mode
...
DebugOnlyBridgeAnalyzerAdapterControlledRuntimeInputEnvelopeActivationPreflightDiagnosticMode?
_runtimeInputEnvelopeActivationPreflightDiagnosticModeByWire(String wire) {
  for (final mode
...
const _disabledRuntimeInputEnvelopeDiagnosticFlag =
    '--disabled-runtime-input-envelope-diagnostic=';
const _runtimeInputEnvelopeActivationPreflightDiagnosticFlag =
